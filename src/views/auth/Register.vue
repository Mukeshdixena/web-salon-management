          ...
          <div class="card shadow-lg border-0 rounded-4">
            <div class="card-body p-5">
              <div class="text-center mb-5">
                ...
                <p class="text-muted">Create your salon account and get approved by admin</p>
              </div>

              <form @submit.prevent="register">
                <div class="mb-3">
                  <input v-model="form.name" type="text" class="form-control form-control-lg rounded-3" 
                ...
                <button type="submit" class="btn btn-success w-100 btn-lg rounded-3 mb-3" :disabled="loading">
                ...
                <div v-if="success" class="alert alert-success rounded-3 text-center">
                  ...
                  Your account is pending admin approval. You'll get an email when approved.
                </div>
...
<style scoped>
.bg-gradient { background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); }
</style>